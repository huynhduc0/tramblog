                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                    ...
                                    <div class="card-header">
                                        <strong>Sửa loại hàng</strong>
                                        chọn và sửa
                                    </div>
                                    <div class="card-body card-block">
                                        <form class="form-horizontal" method="post" action="{{url('updatetypeproduct')}}">
                                            {{csrf_field()}}
                                                ...
                                                <div class="col col-md-12">
                                                    <div class="input-group">
                                                        <div class="input-group-btn">
                                                            <div class="btn-group">
                                                                <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle btn btn-primary">Brand</button>
                                                                <div  tabindex="-1" aria-hidden="true" role="menu" class="dropdown-menu">
                                                                    @foreach ($brand as $value)
                                                                    <button type="button" value="{{$value['brandname']}}" tabindex="0" class="dropdown-item"
                                                                    onclick="setName('{{$value['id']}}','{{$value['brandname']}}')">{{$value['brandname']}}</button>
                                                                    @endforeach
                                                                </div>
                                                            </div>
                                                        </div>
                                 ...
                                 <div class="card-header">
                                        <strong>Thêm brand</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="addtypeproduct" method="post" class="form-inline">
                                            <div class="form-group">
                                                {{csrf_field()}}
                                                ...
                                                <td>{{count($value['count'])}}</td>
                                                 <td>
                                                    ...
                                                    <div class="table-data-feature">
                                                        @if($value['status']==0)
                                                        <a href="{{url('duyetloaihang/'.$value['id'])}}"><button class="item" data-toggle="tooltip" data-placement="top" title="Duyệt">
                                                            <i class="zmdi zmdi-mail-send"></i>
                                                        </button>
                                                        @else
                                                         </a>
                                                         <a href="{{url('chanloaihang/'.$value['id'])}}">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="user-data m-b-30">
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Sản phẩm</h3>
                                            ...
                                            <tbody>
                                                <tr>
                                                   @foreach($sanpham as $value)
                                                    ...
                                                    <td> <img src="{{$value['img'][0]}}" class="img-responsive"></td>
                                                     <td>{{$value['count']}}</td>
                                                      <td>{{$value['rate']}} in {{$value['rate_count']}} </td>
                                                    <td>

                                                    <div class="table-data-feature">
                                                        @if($value['active']==0)
                                                        <a href="{{url('hienhang/'.$value['id'])}}"><button class="item" data-toggle="tooltip" data-placement="top" title="Duyệt">
                                                            <i class="zmdi zmdi-mail-send"></i>
                                                        </button>
                                                        @else
                                                         </a>
                                                         <a href="{{url('hienhang/'.$value['id'])}}">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Không cho hiển thị">
                                                            <i class="zmdi zmdi-delete"></i>
                                                        </button>  
                                                        </a>
                                                        @endif         
                                                          <a href="{{url('suaproduct/'.$value['id'])}}"><button class="item" data-toggle="tooltip" data-placement="top" title="Sửa">
