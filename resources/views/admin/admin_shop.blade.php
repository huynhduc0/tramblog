                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr-shadow">
                                               ...
                                               <td class="desc">{{$value['name']}}</td>
                                                <td>
                                                    <span class="block-email">{{$value['email']}}</span><br>
                                                    <span class="block-email">{{$value['phone']}}</span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="table-data-feature">
                                                        <a href="{{url('duyethang/'.$value['id'])}}"><button class="item" data-toggle="tooltip" data-placement="top" title="Duyệt">
                                                            <i class="zmdi zmdi-mail-send"></i>
                                                        </button>
                                                         </a>
                                                         <a href="{{url('chanhang/'.$value['id'])}}">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Từ chối">
